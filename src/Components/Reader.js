      ...
      {txt.isLoading === true ? (
        ...
        <div className="book-div">
          ...
          <div className="content_div">
            ...
            <div style={{display:'flex',padding:'1vw', wdith:'100%',borderBottom: '1px solid rgb(94, 94, 94)'}}>
              <div style={{width:'70%'}}>
              ...
              <div style={{width:'30%'}}>
                <Link to='/' style={{textDecoration:'none'}}><Button variant="contained" id='goBackBtn'>Search Again!</Button></Link>
              </div>
            ...
            <div style={{ display: "flex", width: "100%" }}>
              ...
              <div style={{ width: "50%", padding: "1vw" }}>
                ...
                <strong style={{ color: "dodgerblue" }}>Contributers: </strong>
                ...
                <div>
                  {
                    ...
                    >
                      <Button style={{backgroundColor:'#ff8000'}} variant="contained" endIcon={ <ReadMoreIcon /> }>Click to read on Google &nbsp;</Button>
                    </a>
                  }
                </div>
              </div>
